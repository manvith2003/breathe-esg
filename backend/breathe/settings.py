"""
Django settings for BreatheESG prototype.
"""
import os
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-dev-key-change-in-prod-breatheesg-2024')
...
# Database — uses SQLite locally, Postgres in production via DATABASE_URL
